...
def msg_gen(fs: float, x_size: int = 4, y_size: int = 4) -> Generator[AxisArray, None, None]:
    sidx = 0
    while True:
...
def test_concat() -> None:
    ...
    batch_cat = AxisArray.concatenate(*batches, dim = 'batch', axis = AxisArray.Axis.TimeAxis(fs / batch_size))
